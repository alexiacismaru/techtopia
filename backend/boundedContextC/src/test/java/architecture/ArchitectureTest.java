...
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prog6.boundedContextC.domain..";
    private static final String ADAPTER_LAYER = "be.kdg.prog6.boundedContextC.adapter..";
    private static final String CORE_LAYER = "be.kdg.prog6.boundedContextC.core..";
    private static final String PORT_LAYER = "be.kdg.prog6.boundedContextC.port..";
